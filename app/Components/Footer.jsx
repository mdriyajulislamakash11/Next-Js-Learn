    ...
    <footer className="bg-gray-100 text-gray-700 py-10 mt-10">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-6 flex-wrap mb-6">
          ...
          <Link href="/jobs" className="hover:text-black">Jobs</Link>
          <Link href="/press" className="hover:text-black">Press Kit</Link>
        </div>
        ...
        {/* Copyright */}
        <p className="text-sm">
          © {new Date().getFullYear()} — All Rights Reserved | Your Website Name
        </p>
      </div>
    </footer>
  );
